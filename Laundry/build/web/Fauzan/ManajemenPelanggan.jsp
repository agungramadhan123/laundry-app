<%-- 
    Document   : ManajemenPelanggan
    Created on : Dec 20, 2025, 2:58:30 PM
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="${pageContext.request.contextPath}/Agung/ManajemenLayanan.jsp" class="<%= currentPage.equals("/Fauzan/ManajemenLayanan.jsp") ? "active" : "" %>">
        ...
        <div class="content" style="position: relative; padding-bottom: 80px;">
            <h1 style="color: white; margin-bottom:50px">Manajemen Pelanggan</h1>
