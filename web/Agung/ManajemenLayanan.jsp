<%-- 
    Document   : ManajemenLayanan
    Created on : Dec 20, 2025, 2:58:43 PM
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="ms-auto d-flex align-items-center" style="margin-right: 5px">
                <span class="navbar-text me-2">
                    <a class="nav-link d-flex align-items-center gap-2" href="${pageContext.request.contextPath}/EditProfileAdminController?user_id=${user.id}">
        ...
        <div class="content" style="position: relative; padding-bottom: 80px;">
            <h1 style="color: white; margin-bottom:50px">Manajemen Layanan</h1>
